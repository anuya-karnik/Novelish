        ...
        <div className="row">
          ...
          <div id="readlist" className="toread col-8">
            <div className="list-controls">
              ...
              <div className="col">
                {/* <button id='refresh-once' onclick={refreshPage()} type="button" className="add btn btn-primary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-clockwise" viewBox="0 0 16 16">
